 ...
 * 6. arr[low] is somewhere back, but i am considering teh arr[low] is also in same point where we are pointing arr[mid]
 * 
 ...
 * arr[mid] === 0
 *  - we need to move the 0 to the array [0... low -1], because those are the one who holds 0's
 ...
 *  - now I am simply shrinking the high
