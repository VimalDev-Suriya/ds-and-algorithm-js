...
class SinglyLinkedList {
  constructor() {
    ...
    // * We can use tail pointer in Singly linked list - which increases the performance of push
    // * It wont take much memory - where it only stores the reference of the last element
    this.tail = null;
    this.length = 0;
  }
