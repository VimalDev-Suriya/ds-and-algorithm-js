 ...
 *
 * Overflow cases.
 * Consider the array which has the length MAX_INT, on this occasion, if the target element is the last element, we will be resulted in the scenario like below
 ...
 * so we will be reduing the end - start which will not result in overflow.
 */
