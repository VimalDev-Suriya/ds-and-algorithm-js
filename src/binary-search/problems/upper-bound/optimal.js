...
const upperBound = (arr, target) => {
  ...
  // By definition, if the target is greater than or equal to all elements in the array, the upper bound must return arr.length (out of bounds). Because your code initializes up to the last index, it will incorrectly claim the upper bound is inside the array.
  let up = arr.length;
  let start = 0;
...
console.log(upperBound([2, 4, 6, 9, 10, 11, 16], 19)); // 7 (fixed)
